...
cfg_list_collector.concat(cur_common_base.copy().override('logdir', ['run-logs/part2-0']).override('custom_env', ['export SAMGRAPH_TRAIN_SET_PART=0/2']))
cfg_list_collector.concat(cur_common_base.copy().override('logdir', ['run-logs/part2-1']).override('custom_env', ['export SAMGRAPH_TRAIN_SET_PART=1/2']))
cfg_list_collector.concat(cur_common_base.copy().override('logdir', ['run-logs/part4-0']).override('custom_env', ['export SAMGRAPH_TRAIN_SET_PART=0/4']))
cfg_list_collector.concat(cur_common_base.copy().override('logdir', ['run-logs/part4-1']).override('custom_env', ['export SAMGRAPH_TRAIN_SET_PART=1/4']))
cfg_list_collector.concat(cur_common_base.copy().override('logdir', ['run-logs/part4-2']).override('custom_env', ['export SAMGRAPH_TRAIN_SET_PART=2/4']))
cfg_list_collector.concat(cur_common_base.copy().override('logdir', ['run-logs/part4-3']).override('custom_env', ['export SAMGRAPH_TRAIN_SET_PART=3/4']))
