...
set terminal svg size 2000,800 font "Helvetica,16" enhanced background rgb "white" dl 2
...
bs_str = "2000 2000 1000 2000 8000 8000 4000 8000"
...
plot cmd_filter_dat_by_policy("_".app, ds, bs, "^Rep")     using (column(col_cache_percent) > cache_percent_lb ? column(col_cache_percent) : 1/0):(column(col_step_time_feat_copy)*1000)     w lp ps 0.5 lw 1 lc 3 title "Rep" \
    ...
    ,cmd_filter_dat_by_policy("_".app, ds, bs, "MPSPhase") using (column(col_cache_percent) > cache_percent_lb ? column(col_cache_percent) : 1/0):(column(col_step_time_feat_copy)*1000)     w lp ps 0.5 lw 3 lc 4 title "CollPhase" \
