    ...
    ext_modules=[
        CUDAExtension(
            ...
            sources=[
                ...
                'samgraph/common/cpu/cpu_optimized_hashtable.cc',
                ...
                'samgraph/common/cuda/cuda_loops_common.cc',
                'samgraph/common/cuda/cuda_loops_dedicated.cc',
                'samgraph/common/cuda/cuda_loops_offload.cc',
                'samgraph/common/cuda/cuda_loops_standalone.cc',
                ...
                'samgraph/common/cuda/cuda_random_walk.cu',
