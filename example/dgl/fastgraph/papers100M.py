...
class Papers100M:
    ...
    def to_dgl_graph(self):
        ...
        g_idx = dgl.heterograph_index.create_unitgraph_from_csc(1, self.num_node, self.num_node, self.indptr, self.indices, self.eids, ['csr', 'csc'])
        return dgl.DGLGraph(g_idx)
