...
plot cmd_filter_dat_by_policy('random')      using col_copy_time:xticlabels(col_dataset) lc "#ff9900" title 'Random' \
    ,cmd_filter_dat_by_policy('degree')      using col_copy_time:xticlabels(col_dataset) lc "#c00000" title 'Degree' \
    ,cmd_filter_dat_by_policy('presample_1') using col_copy_time:xticlabels(col_dataset) lc "#000000" title 'PreSC#1' \
