...
# original FGNN
python ${sam_dir}/train_pinsage.py --dataset papers100M --pipeline --cache-percentage 0.19 --num-sample-worker 1 --num-train-worker 1 2>&1 | tee ${log_dir}/switch_origin_1.log
python ${sam_dir}/train_pinsage.py --dataset papers100M --pipeline --cache-percentage 0.19 --num-sample-worker 1 --num-train-worker 2 2>&1 | tee ${log_dir}/switch_origin_2.log
python ${sam_dir}/train_pinsage.py --dataset papers100M --pipeline --cache-percentage 0.19 --num-sample-worker 1 --num-train-worker 3 2>&1 | tee ${log_dir}/switch_origin_3.log
python ${sam_dir}/train_pinsage.py --dataset papers100M --pipeline --cache-percentage 0.18 --num-sample-worker 1 --num-train-worker 4 2>&1 | tee ${log_dir}/switch_origin_4.log
python ${sam_dir}/train_pinsage.py --dataset papers100M --pipeline --cache-percentage 0.18 --num-sample-worker 1 --num-train-worker 5 2>&1 | tee ${log_dir}/switch_origin_5.log
python ${sam_dir}/train_pinsage.py --dataset papers100M --pipeline --cache-percentage 0.17 --num-sample-worker 1 --num-train-worker 6 2>&1 | tee ${log_dir}/switch_origin_6.log
python ${sam_dir}/train_pinsage.py --dataset papers100M --pipeline --cache-percentage 0.17 --num-sample-worker 1 --num-train-worker 7 2>&1 | tee ${log_dir}/switch_origin_7.log
