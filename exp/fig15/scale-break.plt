...
set key samplen 1.5 spacing 1.5 height 0.2 width 0 font ',11' #maxrows 1 at graph 0.02, graph 0.975  noopaque
...
plot resfile using ($2):xticlabels(1) t "Sample"  w histogram lc rgb "#ff9900",\
     resfile using ($3):xticlabels(1) t "Extract" w histogram lc rgb "#c00000", \
     resfile using ($4):xticlabels(1) t "Train"   w histogram lc rgb "#0000ee", \
	 resfile using ($5):xticlabels(1) t "FGNN"    w lp lt 1 lw 3 pt 6 ps 1.5 lc rgb '#000000', \
