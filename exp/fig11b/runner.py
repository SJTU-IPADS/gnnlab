...
cur_common_base = (ConfigList()
  ...
  .override('sample_type', [SampleType.kKHop2])
  .override('dataset', [Dataset.papers100M])
...
cfg_list_collector.concat(cur_common_base.copy()
  .override('cache_percent', percent_gen(0, 30, 5))
...
if __name__ == '__main__':
  ...
  # optimal results requires a seperate run
