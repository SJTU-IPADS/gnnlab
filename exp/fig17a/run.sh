...
# original FGNN
python ${switcher_dir}/train_pinsage_no_switch_async.py --dataset papers100M --pipeline --cache-percentage 0.17 --num-sample-worker 1 --num-train-worker 1 2>&1 | tee ${log_dir}/switch_origin_1.log
python ${switcher_dir}/train_pinsage_no_switch_async.py --dataset papers100M --pipeline --cache-percentage 0.17 --num-sample-worker 1 --num-train-worker 2 2>&1 | tee ${log_dir}/switch_origin_2.log
python ${switcher_dir}/train_pinsage_no_switch_async.py --dataset papers100M --pipeline --cache-percentage 0.17 --num-sample-worker 1 --num-train-worker 3 2>&1 | tee ${log_dir}/switch_origin_3.log
python ${switcher_dir}/train_pinsage_no_switch_async.py --dataset papers100M --pipeline --cache-percentage 0.17 --num-sample-worker 1 --num-train-worker 4 2>&1 | tee ${log_dir}/switch_origin_4.log
python ${switcher_dir}/train_pinsage_no_switch_async.py --dataset papers100M --pipeline --cache-percentage 0.17 --num-sample-worker 1 --num-train-worker 5 2>&1 | tee ${log_dir}/switch_origin_5.log
...
touch fig17a.dat
echo -e "Config\t\"w/o DS\"\t\"w/ DS\"" > fig17a.dat
parse_switch_log 1 ${log_dir} fig17a.dat
parse_switch_log 2 ${log_dir} fig17a.dat
parse_switch_log 3 ${log_dir} fig17a.dat
parse_switch_log 4 ${log_dir} fig17a.dat
parse_switch_log 5 ${log_dir} fig17a.dat
parse_switch_log 6 ${log_dir} fig17a.dat
parse_switch_log 7 ${log_dir} fig17a.dat
