...
class ComFriendster:
    def __init__(self, path):
        ...
        self.num_node = 65608366
        self.num_edge = 1806067135
        self.feat_dim = 256
        self.num_class = 172
        self.num_train_set = 1207179
        self.num_valid_set = 214338
        self.num_test_set = 125265
        ...
        print('Loading ComFriendster uses {:4f} secs.'.format(toc-tic))
    ...
    def to_dgl_graph(self):
        ...
        g.ndata['feat'] = torch.empty((65608366, 256), dtype=torch.float32)
        g.ndata['label'] = torch.empty((65608366,), dtype=torch.long)
